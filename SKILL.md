...
```text
/xxd-panel-087 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，087 设计在下）
2. 左右对照（原图在左，087 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-087/<fresh-task>/
...
- `references/xxd-panel-087-prompt.zh-CN.md`
- `references/xxd-panel-087-prompt.en.md`
