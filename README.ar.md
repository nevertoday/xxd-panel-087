...
# 🦁 XXD Panel 087｜خريطة العلاقات بالخيط الأحمر

### يحوّل الصورة إلى خريطة نظام ملموسة بخيوط حقيقية
...
تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 087 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

يفقد رسم الصورة كمخطط تدفق عادي العلاقات المكانية الحقيقية بين عناصرها، بينما تحوّل الخطوط الحمراء العشوائية والعقد التي تملأ الصفحة العمل إلى لوحة تحرٍّ رخيصة أو digital network UI.

يستخرج **Panel 087** العنصر والمحيط والبنية والوضعية والعلاقات السردية من الصورة، ويفككها إلى عدد قليل من العقد الشبيهة بالدبابيس ذات المعنى، ثم يعيد وصلها بخيوط حقيقية لتكوين خريطة أنظمة ملموسة. تكون العلاقات أكثر كثافة في المركز وتتراخى تدريجيًا عند الأطراف؛ وتنتج الخيوط القرمزية أو المرجانية الحمراء فوق كرتون أبيض طبيعي هندسة ناشئة، مع الحفاظ على ظلال الغرز والتقاطعات والحجب والبطاقات المكتوبة يدويًا وأخطاء العمل اليدوي الحقيقية.

### مناسب لـ

- **فهم العلاقات داخل العنصر:** تحويل اتجاهات الحركة والمواضع المكانية والتحولات البنيوية والقرائن البيئية إلى عقد وروابط.
- **الحصول على ملمس تركيب مادي حقيقي:** استخدام الدبابيس والخيط القطني والبطاقات الورقية وظلال الغرز وفروق الشد والحجب الطفيف بدل مخطط شبكة مرسوم بالحاسوب.
- **صنع صورة معقدة ولكن منظمة:** اتخاذ عقدة أو علاقة محورية واحدة مركزًا، مع مركز كثيف وأطراف أكثر انفتاحًا وفراغ سلبي كافٍ.
- **مرونة التسليم:** دعم تكوين أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وخلفيات لأربعة أجهزة ومعالجة مجلدات الصور دفعة واحدة.

### بداية سريعة

> استخدم XXD Panel 087 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** عقد ملموسة · روابط بخيط أحمر · هندسة ناشئة · تعليقات مكتوبة يدويًا · ملمس جدار بحثي · فراغ ذو معنى
...
|---|---|
| **الناتج** | ملصق خريطة أنظمة مادية واضح العلاقات وذو ملمس محسوس وطابع بحثي |
| **البصمة الواضحة** | عقد شبيهة بالدبابيس، وخيوط قرمزية، وتجميع مركزي، وأطراف مفتوحة، وبطاقات ورقية، وآثار ملاحظات مكتوبة يدويًا |
| **احترام المصدر** | يستخرج عقدًا وروابط ذات معنى من العنصر والبنية والوضعية والاتجاه والعلاقات المكانية بدل نسخ المشهد كما هو |
...
```text
تحليل العنصر والمحيط والبنية والوضعية والعلاقات السردية → تفكيكها إلى عدد قليل من Nodes ذات المعنى → إنشاء Edges / Links بخيوط حقيقية → تكوين وصلات شعاعية ومتجمعة ومثلثة ومتعددة الأضلاع وعابرة للمناطق حول العلاقة المحورية → مركز كثيف وأطراف أكثر انفتاحًا → إضافة الدبابيس والبطاقات الورقية وظلال الغرز والحجب وأخطاء العمل اليدوي → إدخال ملاحظات مكتوبة يدويًا قرب العقد وفي الفراغ
```

## سمات النتيجة النهائية

- تقابل كل عقدة محيطًا أو تحولًا بنيويًا أو اتجاه حركة أو موضعًا أو قرينة بيئية في الصورة الأصلية؛ ولا تُضاف عقد عديمة المعنى.
- تستخدم الخيوط قرمزيًا أو أحمر مرجانيًا أو أحمر دافئًا واضحًا لكن منضبطًا، وتبقى الخلفية بيضاء طبيعية أو بيضاء دافئة أو رمادية فاتحة أو شديدة الشحوب ومتناغمة.
- يمكن للعقد تكوين وصلات شعاعية ومتجمعة ومثلثة ومتعددة الأضلاع وعابرة للمناطق، لكن من دون تشابك عشوائي أو ملء الصفحة كلها.
- تصنع الدبابيس والبطاقات الورقية وظلال الغرز وفروق شد الخيوط والتقاطعات والحجب ملمس تركيب مادي حقيقي.
- يبقى النص ملاحظات مراقبة قليلة مكتوبة يدويًا؛ وتُتجنب cyber UI ولوحات الجرائم والدبابيس الكرتونية ومخططات التدفق العادية وخرائط العقل النمطية.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-087-prompt.en.md)
...
/xxd-panel-087 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-087 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-087 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-087 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-087 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 087 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-087 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-087`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-087-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-087-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

تم تحديث سلسلة XXD Panel الحالية لتشمل 001–112، ويحتفظ كل Panel بموجّهه الأصلي ومنطقه الجمالي المستقل. الجدول أدناه هو الدليل التاريخي حتى وقت إصدار هذا المشروع؛ يسرد 001–087 بصورة متتابعة، ويظهر المشروع الحالي بخط عريض.
